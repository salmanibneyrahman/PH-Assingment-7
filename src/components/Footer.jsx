  ...
  return (
    <footer className="bg-[#1a5c38] text-white pt-10 pb-6 px-4 md:px-8">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-4">
        ...
        {/* Tagline */}
        <p className="text-green-200 text-sm max-w-auto leading-relaxed">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#"
            aria-label="Facebook"
            className="w-9 h-9 rounded-full border border-green-400 flex items-center justify-center bg-white hover:bg-green-700 transition-colors"
          >
          ...
          <a
            ...
            className="w-9 h-9 rounded-full border border-green-400 flex items-center justify-center bg-white hover:bg-green-700 transition-colors"
          >
            <svg className="w-4 h-4 stroke-white fill-black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
